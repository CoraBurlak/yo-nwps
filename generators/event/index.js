...
module.exports = class extends Generator {
  ...
  prompting() {
    var moduleName = this.options.moduleName;
    this.log(
        `Hold tight, one ${moduleName}-events.component coming right up!`
    );
  }

  writing() {
    var moduleName = this.options.moduleName;
    this.createNwpsFile(`events.component.ts`, `${moduleName}s/entry/events/${moduleName}-events.component.ts`);
  }
